...
const { SPRING_WEBSOCKET } = import('generator-jhipster/jdl/jhipster/websocket-types.js');
const { OAUTH2, SESSION } = import('generator-jhipster/jdl/jhipster/authentication-types.js');
const { GATEWAY } = import('generator-jhipster/jdl/jhipster/application-types.js');
const { replaceReactTranslations } = import('./transform-react.cjs');
...
export default { cleanup, writeFiles, files };
